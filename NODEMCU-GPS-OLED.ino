...
const double Home_LAT = **.*****;                       // Replace with your Home Latitude
const double Home_LNG = **.*****;                       // Replace with your Home Longitude
...
void setup()
{  
  display.begin(SSD1306_SWITCHCAPVCC, 0x3C);            // Initialize display with address 0x3C for 128x64
